...
type Ingredient = { id: string; name: string; category: string | null; current_price: number; current_price_date?: string | null; unit_id: string | null; active: boolean; unit?: Unit | null }
...
type Recipe = { id: string; name: string; category: string | null; description: string | null; procedure: string | null; equipment: string | null; allergens: string | null; notes: string | null; standard_portions: number; target_food_cost_percent: number | null; manual_sale_price: number | null; active: boolean; recipe_ingredients?: RecipeLine[] }
...
export default function Home() {
  ...
  async function refreshAll() {
    ...
    const [c, e, u, i, r] = await Promise.all([
      ...
      supabase.from('ingredients').select('id,name,category,current_price,current_price_date,unit_id,active,unit:units(id,code,name)').order('name'),
      supabase.from('recipes').select('id,name,category,description,procedure,equipment,allergens,notes,standard_portions,target_food_cost_percent,manual_sale_price,active,recipe_ingredients(id,recipe_id,ingredient_id,quantity,unit_id,sort_order,ingredient:ingredients(id,name,category,current_price,unit_id,active,unit:units(id,code,name)),unit:units(id,code,name))').order('name'),
    ])
